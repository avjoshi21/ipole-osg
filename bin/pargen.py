...
spin=float(eval(grmhdModel[2:]))
tilt = sys.argv[3]
dumpStart = int(sys.argv[4])
dumpEnd = int(sys.argv[5])
r="/home/abhishek.joshi/m87_v3"

cadence=1
normBatchSize = 1000
bh='M87'

munitFilesStr=f"/home/abhishek.joshi/m87_v3/munits/windows/{ext}/MunitVals_{bh}_{tilt}_{disk[0]}a{spin}_*.txt"
...
for munitFile in munitFiles:
    ...
    grmhdDirectoryStr=f"/home/abhishek.joshi/protected/{ext}/{disk}/{grmhdModel[1:]}/288x128x128_KHARMA/dumps/torus.*.h5"
